...
/** Patrocinadores oficiales — logos en /public/sponsors (ver scripts/fetch_sponsor_logos.py) */
export const sponsors: Sponsor[] = [
  { id: 'adium', name: 'Adium', logo: '/sponsors/adium.png' },
  { id: 'calox', name: 'Calox', logo: '/sponsors/calox.png' },
  { id: 'eurofarma', name: 'Eurofarma', logo: '/sponsors/eurofarma.png' },
  { id: 'leti', name: 'Leti', logo: '/sponsors/leti.png' },
  { id: 'urogastrol', name: 'Urogastrol', logo: '/sponsors/urogastrol.svg' },
  { id: 'cuevas', name: 'Cuevas', logo: '/sponsors/cuevas.svg' },
  { id: 'bnh', name: 'B.N.H.', logo: '/sponsors/bnh.svg' },
  { id: 'lasermed', name: 'Lasermed', logo: '/sponsors/lasermed.png' },
  { id: 'angelus', name: 'Angelus', logo: '/sponsors/angelus.svg' },
  { id: 'clinicalar', name: 'Clinicalar', logo: '/sponsors/clinicalar.png' },
  { id: 'dermaskin', name: 'Dermaskin', logo: '/sponsors/dermaskin.jpg' },
  ...
  { id: 'gurve', name: 'Gurve', logo: '/sponsors/gurve.jpg' },
  ...
  { id: 'plusandex', name: 'Plusandex', logo: '/sponsors/plusandex.svg' },
  ...
  { id: 'valmorca', name: 'Valmorca', logo: '/sponsors/valmorca.jpg' },
  ...
  { id: 'fc-laboratorios', name: 'F.C. Laboratorios', logo: '/sponsors/fc-laboratorios.svg' },
  { id: 'hygea', name: 'Hygea', logo: '/sponsors/hygea.svg' },
  { id: 'dalmed', name: 'Dalmed', logo: '/sponsors/dalmed.svg' },
  { id: 'zooriack', name: 'Zooriack', logo: '/sponsors/zooriack.svg' },
